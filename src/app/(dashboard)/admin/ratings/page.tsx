...
const Ratings = () => {
  const [ratingsData, setRatingsData] = useState<Rating[]>([
    ...
    },
    {
      name: 'Bob Lee',
      rating: 5,
      comment: 'Loved it! Will definitely come again.',
    },
    {
      name: 'Charlie Brown',
      rating: 2,
      comment: 'The experience was okay, but there were issues.',
    },
    {
      name: 'Emily Davis',
      rating: 4,
      comment: 'Overall good, but some minor issues.',
    },
    {
      name: 'Grace Taylor',
      rating: 4,
