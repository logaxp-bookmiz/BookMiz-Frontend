        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              ...
              <span className="font-semibold text-gray-700 group-hover:text-primary-500 transition-colors font-dmsans">Google</span>
            </button>
            ...
            >
              ...
              <span className="font-semibold text-gray-700 group-hover:text-primary-500 transition-colors font-dmsans">Facebook</span>
            </button>
          </div>
          ...
          <p className="mt-8 text-center text-sm text-gray-600 font-dmsans">
            ...
            <Link href="/register" className="font-bold text-primary-500 hover:text-primary-600 transition-colors">
              Sign up for free
            </Link>
          </p>
        </div>
